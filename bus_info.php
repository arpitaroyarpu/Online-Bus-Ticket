            ...
            <div class="jumbotron">
                <div class="container-fluid">
                    ...
                    <form action="" method="post" class="form-horizontal">
                        ...
                        <button type="submit" class="btn-xs btn-primary" style="margin-left: 5px;">GO</button>
                    </form>

                    <?php
                            // Check if the form has been submitted
                            if ($_SERVER["REQUEST_METHOD"] === "POST") {
                                // Check if passenger_count is set before using it in the action
                                $passenger_count = isset($_POST['passenger_count']) ? $_POST['passenger_count'] : 0;
                            ?>

                    <form method="post" class="form-horizontal"
                        action="bus_info.php?bus_id=<?php echo $selected_bus ?>&count=<?php echo $passenger_count ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="email" placeholder="Destination"
                                    name="destination">
                            </div>
                        </div>
                        ...
                        <button class="btn btn-primary" name="book" style="margin-left: 40%; margin-top: 15px;">Book
                            Tickets</button>
