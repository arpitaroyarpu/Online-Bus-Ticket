     ...
     $amount=$_POST['amount'];
       ...
       if($connection->connect_error)
          ...
          else
          {
              ...
              $stmt=$connection->prepare("INSERT INTO payment(amount,name,email,address,city,state,zip_code,card_name,card_number,exp_month,exp_year,cvv) VALUES(?,?,?,?,?,?,?,?,?,?,?,?)");
        ...
        <form method="POST">
            ...
            <div class="row">
                ...
                <div class="col">
                    ...
                    <div class="inputBox">
                        <span>city :</span>
                        <input type="text" placeholder="sylhet" name="city">
                    </div>

                    <div class="flex">
                        <div class="inputBox">
                            <span>state :</span>
                            <input type="text" placeholder="Bangladesh" name="state">
                        </div>
                        <div class="inputBox">
                            <span>zip code :</span>
