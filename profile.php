...
<div class="container" style="width: 50%;">
    ...
    <img src="admin/images/<?php echo $image; ?>" width="200" style="margin-left: 32%;" class="img-circle"
        alt="Profile">
    <br><br><br><br>
    <div class="tab">
        <button class="tablinks" style="width: 33%" onclick="openCity(event, 'Personel Details')">Personal
            Details</button>
        ...
        <table class="table table-striped" style="width: 50%">
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <form action="includes/cancel.php?orderid=<?php echo $orderid ?>&bus_id=<?php echo $busid ?>"
                            method="post">
    ...
    ?>
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input value="<?php echo $user_password ?>" id="myInput" type="password" class="form-control"
                    name="user_password">
            </div>
